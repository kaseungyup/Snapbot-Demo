...
if platform.system() == "Darwin":
    dxl_lib = cdll.LoadLibrary("realworld_func/DynamixelSDK/c/build/mac/libdxl_mac_c.dylib") 
else:
    dxl_lib = cdll.LoadLibrary("realworld_func/DynamixelSDK/c/build/linux64/libdxl_x64_c.so")     # for linux 64bit
# dxl_lib = cdll.LoadLibrary("../../c/build/linux_sbc/libdxl_sbc_c.so")   # for SBC linux
# dxl_lib = cdll.LoadLibrary("/Users/hansoo/Project/Snapbot-meta-RL/realworld_func/DynamixelSDK/c/build/mac/libdxl_mac_c.dylib")      # for Mac OS
